      ...
      {navBarRendered && (
        <div className="pt-28 ">
          ...
          <h1
            ...
            style={{ fontFamily: "Chivo, sans-serif" }}
          >
            <span className="text-yellow-300 px-2">for Your Brand</span>
          </h1>
          ...
          <div className="flex justify-center mt-10 gap-4 ">
            <button
              onClick={handleMore}
              className="border-[3px] mb-5 border-white text-white text-xl flex justify-center py-3 px-4 md:px-6 rounded-2xl shadow-[#F2F625] shadow-md hover:cursor-pointer transition-transform duration-300 transform hover:scale-105 hover:border-[#F2F625]"
              style={{ fontFamily: "Adamina, serif" }}
            >
