      ...
      <div className="p-10 text-white mx-auto bg-gray-900 px-4 sm:px-6 lg:px-8 ">
        <div className="flex flex-col">
          ...
          <div className="text-content w-full">
            ...
            <h3 className="text-lg  mt-5 mb-5">
            ...
            <h3 className="text-lg mt-5 mb-5">
              <span className="font-bold text-xl">Entertainment and Activities:</span>{" "}
            ...
            <h3 className="text-xl sm:text-2xl font-bold mt-5">Bangalore</h3>
            <p className="text-lg sm:text-lg  mb-5 mt-5">
            ...
            <h3 className="text-xl sm:text-2xl font-bold mt-5 ">Delhi</h3>
            <p className="text-lg sm:text-lg mb-5 mt-5">
            ...
            <h3 className="text-xl sm:text-2xl font-bold mt-5">Hyderabad</h3>
            <p className="text-base sm:text-lg leading-relaxed mb-5 mt-5">
            ...
            <h3 className="text-xl sm:text-2xl font-bold mt-5">Chennai</h3>
            ...
            <h3 className="text-xl sm:text-2xl font-bold mt-5">Ahmedabad</h3>
            <p className="text-base sm:text-lg leading-relaxed mb-5 mt-5">
            ...
            <h3 className="text-xl sm:text-2xl font-bold mt-5">Dubai</h3>
