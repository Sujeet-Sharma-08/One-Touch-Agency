      ...
      <div className="p-10 text-white mx-auto bg-gray-900 px-4 sm:px-6 lg:px-8 ">
        <div className="flex flex-col">
          ...
          <div className="text-content w-full">
            ...
            <h3 className="text-xl sm:text-2xl font-bold mt-5 mb-5">Why Choose Us as Your MICE Event Management Partner</h3>
            ...
            <div className="flex justify-center mt-7 m-5 sm:mb-10 sm:m-10">
              <Link to="/contactus">
