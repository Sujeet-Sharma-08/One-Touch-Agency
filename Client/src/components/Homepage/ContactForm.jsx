...
const ContactForm = () => {
  ...
  return (
    ...
    >
      {/* horizontal line */}
      <div className="w-full -ml-5 md:-ml-6 -mt-14">
        <hr className="ml-12" style={{ border: "0.5px solid yellow" }} />
      </div>

      <h1
        className="text-5xl mt-[3rem] font-medium flex justify-center text-white"
          ...
          >
            ...
            <div className="flex justify-center items-center">
              <input
                ...
                className="w-[16rem] py-[10px] md:w-[14rem] lg:w-[17rem] xl:w-[23rem] p-4 rounded-2xl hover:border-yellow-300 border-2 border-[#f2f625]  bg-transparent focus:bg-transparent focus:outline-none"
                required
              />
            </div>
            ...
            <div className="flex justify-center">
              <textarea
                ...
                onChange={handleChange}
                className="w-[16rem] py-[16px] md:w-[14rem] lg:w-[17rem] xl:w-[23rem] p-4 rounded-2xl hover:border-yellow-300 border-2 border-[#f2f625] bg-transparent focus:bg-transparent focus:outline-none"
                required
              ></textarea>
            </div>
