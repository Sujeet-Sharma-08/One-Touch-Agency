...
const Portfolio = () => {
  ...
  return (
    <div className="bg-gray-900">
      ...
      <div className="md:hidden flex p-[10px] gap-2">
        <div className="h-[20rem] w-1/2 flex flex-col gap-2">
          <div
            className={`h-[12rem] transition-transform duration-500 rounded-lg border  ${
              isHovered ? "hover:-translate-y-2 hover:shadow-lg" : ""
            }`}
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
          ...
          <div
            className={`transition-transform h-[8rem] duration-500 rounded-lg border ${
              isHovered ? "hover:-translate-y-2 hover:shadow-lg" : ""
            }`}
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
