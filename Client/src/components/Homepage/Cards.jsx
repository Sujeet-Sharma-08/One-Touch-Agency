...
const Cards = () => {
  ...
  return (
    ...
    >
      <div
        className="absolute left-0 top-0 w-24 h-24 mt-[28rem] md:mt-[6rem] lg:mt-0 md:w-48 md:h-48 lg:w-64 lg:h-64 bg-gray-900  rounded-full"
        style={{ left: "10%", top: "38%", border: "4px solid yellow" }}
      ></div>  
      <div
        className="absolute right-0 bottom-0 w-24 -mb-[3.2rem] h-24 md:w-48 md:h-48 lg:w-64 lg:h-64 md:-mb-[5rem] bg-gray-900 rounded-full"
        style={{ right: "7%", bottom: "22%", border: "4px solid yellow" }}
      ></div>
      <div
        className="absolute left-0 top-0 w-6 hidden sm:block h-6 mt-[31rem] md:w-12 md:h-12 lg:w-16 lg:h-16 md:mt-[6rem] lg:mt-0 bg-gray-900  rounded-full"
        style={{ left: "8%", top: "30%", border: "4px solid yellow" }}
      ></div>
      <div
        className="absolute right-0 bottom-0 hidden sm:block w-6 h-6  md:w-12 md:h-12 lg:w-16 lg:h-16 md:-mb-[6rem] lg:-mb-20 bg-gray-900  rounded-full"
      ...
      <div className="relative text-5xl lg:text-9xl md:text-7xl -ml-40 font-bold pl-44 pt-20 -mb-20 ">
      ...
      <div className="w-full bg-gray-900 h-36 md:h-52"></div>
